...
Quick tip: in VS Code, you can change which format colors are displayed in RGB,fHEX, or HSL by hovering over the color value in the CSS and clicking the top of the popup that appears!
